...
const {
  getAdminDashboard, getAdminStats,
  getAdminUsers, toggleUserActive, adminPatchUser,
  adminGetProducts, adminPatchProduct, adminDeleteProduct,
  adminPatchOrder,
  adminGetBlogPosts, adminCreateBlogPost, adminUpdateBlogPost, adminDeleteBlogPost,
  manageReviews, approveReview,
  manageCoupons, createCoupon, deleteCoupon, patchCoupon,
  getNewsletterSubscribers, broadcastNewsletter,
  getContactMessages, patchContactMessage, deleteContactMessage,
